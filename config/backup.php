...
return [
    ...
    'backup' => [
         ...
         * the backups.
         */
        'name' => env('BACKUP_NAME', 'insaat-yonetimi'),
        ...
        'source' => [
            'files' => [
                 ...
                 */
                'include' => [
                    // Şimdilik SADECE veritabanı yedekleniyor: kod git'te, henüz yüklenen dosya yok.
                    // Evrak/dosya modülü gelince buraya storage_path('app/public') eklenecek.
                ],
    ...
    'notifications' => [
        'notifications' => [
            // Sadece SORUN durumları bildirilir. "Başarılı" mailleri kapalı ki
            // her gün gelen gürültü içinde gerçek hata gözden kaçmasın.
        ...
        'mail' => [
            'to' => env('BACKUP_NOTIFY_MAIL', 'bilgi@boztepeler.com'),
